...
namespace Apsoil.ApsoilWeb {
    ...
    public partial class Service : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback SoilXMLAllOperationCompleted;
        ...
        /// <remarks/>
        public event SoilXMLAllCompletedEventHandler SoilXMLAllCompleted;
        ...
        public void UpdateUserSoil(string Contents) {
            this.Invoke("UpdateUserSoil", new object[] {
                        Contents});
        }
        
        /// <remarks/>
        public void UpdateUserSoilAsync(string Contents) {
            this.UpdateUserSoilAsync(Contents, null);
        }
        
        /// <remarks/>
        public void UpdateUserSoilAsync(string Contents, object userState) {
            ...
            this.InvokeAsync("UpdateUserSoil", new object[] {
                        Contents}, this.UpdateUserSoilOperationCompleted, userState);
        }
        
        private void OnUpdateUserSoilOperationCompleted(object arg) {
            if ((this.UpdateUserSoilCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.UpdateUserSoilCompleted(this, new System.ComponentModel.AsyncCompletedEventArgs(invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://www.apsim.info/SoilXMLAll", RequestNamespace="http://www.apsim.info/", ResponseNamespace="http://www.apsim.info/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public string SoilXMLAll() {
            object[] results = this.Invoke("SoilXMLAll", new object[0]);
            return ((string)(results[0]));
        }
        
        /// <remarks/>
        public void SoilXMLAllAsync() {
            this.SoilXMLAllAsync(null);
        }
        
        /// <remarks/>
        public void SoilXMLAllAsync(object userState) {
            if ((this.SoilXMLAllOperationCompleted == null)) {
                this.SoilXMLAllOperationCompleted = new System.Threading.SendOrPostCallback(this.OnSoilXMLAllOperationCompleted);
            }
            this.InvokeAsync("SoilXMLAll", new object[0], this.SoilXMLAllOperationCompleted, userState);
        }
        
        private void OnSoilXMLAllOperationCompleted(object arg) {
            if ((this.SoilXMLAllCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.SoilXMLAllCompleted(this, new SoilXMLAllCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
        ...
        public string SearchSoils(double Latitude, double Longitude, double Radius, string ASC) {
        ...
        /// <remarks/>
        public void SearchSoilsAsync(double Latitude, double Longitude, double Radius, string ASC) {
            this.SearchSoilsAsync(Latitude, Longitude, Radius, ASC, null);
        }
        
        /// <remarks/>
        public void SearchSoilsAsync(double Latitude, double Longitude, double Radius, string ASC, object userState) {
            ...
            this.InvokeAsync("SearchSoils", new object[] {
                        ...
                        Longitude,
                        Radius,
                        ASC}, this.SearchSoilsOperationCompleted, userState);
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.1")]
    public delegate void UpdateUserSoilCompletedEventHandler(object sender, System.ComponentModel.AsyncCompletedEventArgs e);
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.1")]
    public delegate void SoilXMLAllCompletedEventHandler(object sender, SoilXMLAllCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.1")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class SoilXMLAllCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal SoilXMLAllCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
