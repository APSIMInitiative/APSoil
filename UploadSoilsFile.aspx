<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UploadSoilsFile.aspx.cs" Inherits="Apsoil.UploadSoilsFile" %>
...
<body>
    ...
    <div>
       ...
       <asp:Label ID="Label2" runat="server" 
          Text="This form allows you to upload soils to www.apsim.info. They will then be available in Google Earth."></asp:Label>
