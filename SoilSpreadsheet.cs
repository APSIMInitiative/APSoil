...
namespace ApsimFile
   ...
   public class SoilSpreadsheet
      ...
      static public string OpenXLS(DataTable Table, ProgressNotifier Notifier)
         {
         // --------------------------------------------------------------
      ...
      static public DataTable Export(XmlNode Xml, StringCollection XMLPaths)
         {
         // --------------------------------------------------------------
      ...
      static public void CreateTableFromData(XmlNode Data, DataTable Table, string ChildPath, ref int Row)
         {
         // --------------------------------------------------------------
